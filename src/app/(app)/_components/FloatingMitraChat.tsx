    ...
    <>
      ...
      {!isOpen && (
        <motion.button
          ...
          className="fixed bottom-20 right-4 sm:right-[calc(50%-200px)] z-40 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-r from-morning-sun to-morning-sun-strong text-white shadow-xl border-2 border-white"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-x-3 bottom-20 z-50 mx-auto flex h-[75vh] max-h-[560px] w-full max-w-md flex-col overflow-hidden rounded-card border border-morning-sun/30 bg-cloud shadow-2xl"
          >
            {/* Header */}
