    ...
    const CHECKPOINTS: CheckpointPrompt[] = [
      {
        ...
        subtitle: 'Good morning Warden Sir! Drink a warm glass of water before morning assembly.',
        aiGreeting: 'सुप्रभात Warden Sir! Did you get enough rest last night? How are you feeling this morning?',
      ...
      },
      {
        ...
        aiGreeting: 'Good night Warden Sir. Before you sleep, who made you smile today? How is your energy?',
